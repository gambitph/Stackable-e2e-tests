...
function typeContent() {
	it( 'should allow typing in the block', () => {
		...
		cy.typeBlock( 'ugb/pricing-box', '.ugb-pricing-box__item1 .ugb-pricing-box__title', 'Hello World! 1', 0 )
			.assertBlockContent( '.ugb-pricing-box__item1 .ugb-pricing-box__title', 'Hello World! 1' )
		cy.typeBlock( 'ugb/pricing-box', '.ugb-pricing-box__item1 .ugb-pricing-box__price-prefix', 'P', 0 )
			.assertBlockContent( '.ugb-pricing-box__item1 .ugb-pricing-box__price-prefix', 'P' )
		cy.typeBlock( 'ugb/pricing-box', '.ugb-pricing-box__item1 .ugb-pricing-box__price', '12', 0 )
			.assertBlockContent( '.ugb-pricing-box__item1 .ugb-pricing-box__price', '12' )
		cy.typeBlock( 'ugb/pricing-box', '.ugb-pricing-box__item1 .ugb-pricing-box__price-suffix', '1234', 0 )
			.assertBlockContent( '.ugb-pricing-box__item1 .ugb-pricing-box__price-suffix', '1234' )
		cy.typeBlock( 'ugb/pricing-box', '.ugb-pricing-box__item1 .ugb-pricing-box__subprice', '123456', 0 )
			.assertBlockContent( '.ugb-pricing-box__item1 .ugb-pricing-box__subprice', '123456' )
		cy.typeBlock( 'ugb/pricing-box', '.ugb-pricing-box__item1 .ugb-button--inner', 'Helloo World!! 12', 0 )
			.assertBlockContent( '.ugb-pricing-box__item1 .ugb-button--inner', 'Helloo World!! 12' )
		cy.typeBlock( 'ugb/pricing-box', '.ugb-pricing-box__item1 .ugb-pricing-box__description', 'Hellooo World!!! 123', 0 )
			.assertBlockContent( '.ugb-pricing-box__item1 .ugb-pricing-box__description', 'Hellooo World!!! 123' )
