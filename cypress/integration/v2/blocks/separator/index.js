...
import {
	assertBlockExist, blockErrorTest, switchLayouts, responsiveAssertHelper, assertAdvancedTab,
...
function styleTab( viewport, desktopOnly ) {
	...
	it( `should assert Layer 2 options in ${ lowerCase( viewport ) }`, () => {
		desktopOnly( () => {
			// Test Layer 2
			cy.collapse( 'Layer 2' )
	...
	it( `should assert Layer 3 options in ${ lowerCase( viewport ) }`, () => {
		desktopOnly( () => {
			// Test Layer 3
			cy.collapse( 'Layer 3' )
