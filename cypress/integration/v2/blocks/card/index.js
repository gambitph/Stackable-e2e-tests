...
function typeContent() {
	it( 'should allow typing in the block', () => {
		...
		cy.typeBlock( 'ugb/card', '.ugb-card__item1 .ugb-card__title', 'Hello World! 1', 0 )
			.assertBlockContent( '.ugb-card__item1 .ugb-card__title', 'Hello World! 1' )
		cy.typeBlock( 'ugb/card', '.ugb-card__item1 .ugb-card__subtitle', 'Helloo World!! 12', 0 )
			.assertBlockContent( '.ugb-card__item1 .ugb-card__subtitle', 'Helloo World!! 12' )
		cy.typeBlock( 'ugb/card', '.ugb-card__item1 .ugb-card__description', 'Hellooo World!!! 123', 0 )
			.assertBlockContent( '.ugb-card__item1 .ugb-card__description', 'Hellooo World!!! 123' )
		cy.typeBlock( 'ugb/card', '.ugb-card__item1 .ugb-button--inner', 'Helloooo World!!!! 1234', 0 )
			.assertBlockContent( '.ugb-card__item1 .ugb-button--inner', 'Helloooo World!!!! 1234' )
