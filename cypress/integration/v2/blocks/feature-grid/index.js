...
function typeContent() {
	it( 'should allow typing in the block', () => {
		...
		cy.typeBlock( 'ugb/feature-grid', '.ugb-feature-grid__item1 .ugb-feature-grid__title', 'Hello World! 1', 0 )
			.assertBlockContent( '.ugb-feature-grid__item1 .ugb-feature-grid__title', 'Hello World! 1' )
		cy.typeBlock( 'ugb/feature-grid', '.ugb-feature-grid__item1 .ugb-feature-grid__description', 'Helloo World!! 12', 0 )
			.assertBlockContent( '.ugb-feature-grid__item1 .ugb-feature-grid__description', 'Helloo World!! 12' )
		cy.typeBlock( 'ugb/feature-grid', '.ugb-feature-grid__item1 .ugb-button--inner', 'Hellooo World!!! 123', 0 )
			.assertBlockContent( '.ugb-feature-grid__item1 .ugb-button--inner', 'Hellooo World!!! 123' )
