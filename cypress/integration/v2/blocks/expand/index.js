...
function typeContent() {
	it( 'should allow typing in the block', () => {
		...
		cy.typeBlock( 'ugb/expand', '.ugb-expand__title', 'Hello World! 1', 0 )
			.assertBlockContent( '.ugb-expand__title', 'Hello World! 1' )
		cy.typeBlock( 'ugb/expand', '.ugb-expand__less-text', 'Helloo World!! 12', 0 )
			.assertBlockContent( '.ugb-expand__less-text', 'Helloo World!! 12' )
		cy.typeBlock( 'ugb/expand', '.ugb-expand__more-toggle-text', 'Hellooo World!!! 123', 0 )
			.assertBlockContent( '.ugb-expand__more-toggle-text', 'Hellooo World!!! 123' )
		cy.typeBlock( 'ugb/expand', '.ugb-expand__more-text', 'Helloooo World!!!! 1234', 0 )
			.assertBlockContent( '.ugb-expand__more-text', 'Helloooo World!!!! 1234' )
		cy.typeBlock( 'ugb/expand', '.ugb-expand__less-toggle-text', 'Hellooooo World!!!!! 12345', 0 )
...
function styleTab( viewport, desktopOnly ) {
	beforeEach( () => {
		...
		cy.typeBlock( 'ugb/expand', '.ugb-expand__title', 'Title', 0 )
		cy.typeBlock( 'ugb/expand', '.ugb-expand__less-text', 'Less text', 0 )
		cy.typeBlock( 'ugb/expand', '.ugb-expand__more-toggle-text', 'Show more link', 0 )
		cy.typeBlock( 'ugb/expand', '.ugb-expand__more-text', 'More text here. Lorem Ipsum.', 0 )
		cy.typeBlock( 'ugb/expand', '.ugb-expand__less-toggle-text', 'Show less link', 0 )
	} )
...
function advancedTab( viewport ) {
	...
	cy.typeBlock( 'ugb/expand', '.ugb-expand__title', 'Title here', 0 )
	cy.typeBlock( 'ugb/expand', '.ugb-expand__less-text', 'Less Text here', 0 )
	cy.typeBlock( 'ugb/expand', '.ugb-expand__more-toggle-text', 'More Toggle Text here', 0 )
	cy.typeBlock( 'ugb/expand', '.ugb-expand__more-text', 'More text here', 0 )
	cy.typeBlock( 'ugb/expand', '.ugb-expand__less-toggle-text', 'Less Toggle Text here', 0 )
